    ...
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            (CONPTY.CreatePseudoConsole)(
                ...
                // PSEUDOCONSOLE_WIN32_INPUT_MODE (0x4) is not supported on
                // Windows 10 (build < 22000) and causes spawned processes to exit
                // with STATUS_NOT_IMPLEMENTED.  Omit it for Windows 10 compatibility.
